...
public class NodeListenerFactory {
        ...
        public void handle(MouseEvent t) {
            if (t.getButton() == MouseButton.PRIMARY) {
                ...
                if (t.getSource() instanceof UniqueNode) {
                    ...
                    orgTranslateX = p.getCenterX() * AdminMainController.paneScale;
                    orgTranslateY = p.getCenterY() * AdminMainController.paneScale;
    ...
    private static EventHandler<MouseEvent> mouseDraggedHandler = new EventHandler<MouseEvent>() {
        ...
        public void handle(MouseEvent t) {
            if (t.getButton() == MouseButton.PRIMARY) {
                double offsetX = t.getSceneX() - orgSceneX * AdminMainController.paneScale;
                double offsetY = t.getSceneY() - orgSceneY * AdminMainController.paneScale;

                double newTranslateX = (orgTranslateX + offsetX);
                double newTranslateY = (orgTranslateY + offsetY);
                System.out.println(AdminMainController.paneScale);
